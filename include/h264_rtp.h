...
int h264_dec_rtp(H264_RTP_DEC_TH  pdec_th, const uint8_t *rtp_buf, int buf_len);
...
int32_t h264_enc_rtp_one_nalu(H264_RTP_ENC_TH ph264dec_th, const uint8_t *nal_buf, int32_t buf_len, uint32_t timestamp, uint32_t mark_flg);
